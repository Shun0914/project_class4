import svgPaths from "./svg-47c3cjsiw1";
import { imgGroup } from "./svg-wmv9k";
  ...
  return (
    <div className="bg-white flex-[1_0_0] h-[39.955px] min-h-px min-w-px relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[24px] left-[calc(50%+0.5px)] not-italic text-[#101828] text-[16px] text-center top-[calc(50%-11.96px)] tracking-[-0.3125px]">ログイン</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="flex-[1_0_0] h-[39.955px] min-h-px min-w-px relative rounded-[8px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[24px] left-[calc(50%+0.48px)] not-italic text-[#4a5565] text-[16px] text-center top-[calc(50%-11.96px)] tracking-[-0.3125px]">新規登録</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative rounded-[8px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.11)] shrink-0 w-full" data-name="button" style={{ backgroundImage: "linear-gradient(173.781deg, rgb(255, 160, 76) 2.1423%, rgb(251, 180, 65) 34.595%, rgb(240, 110, 35) 99.971%)" }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[16px] items-center justify-center px-[24px] py-[10px] relative w-full">
          <p className="font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[-0.1504px]">ログイン</p>
        </div>
      </div>
    </div>
  );
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <Component />
      <p className="font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center tracking-[-0.1504px]">Googleでログイン</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col gap-[48px] items-start pb-[48px] pt-[32px] px-[16px] relative rounded-[14px] shadow-[0px_20px_25px_0px_rgba(0,0,0,0.05),0px_8px_10px_0px_rgba(0,0,0,0.05)] shrink-0 w-[358px]">
      <LoginScreen />
      <Frame1 />
    </div>
  );
