import svgPaths from "./svg-p8et80ca9q";
...
function CameraIcon() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="CameraIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="CameraIcon">
          <mask height="18" id="mask0_2_22071" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="18" id="Bounding box" width="18" />
          </mask>
          <g mask="url(#mask0_2_22071)">
            <path d={svgPaths.p1c43c600} fill="var(--fill-0, #5A6B8B)" id="photo_camera" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-px items-center justify-center overflow-clip relative shrink-0 size-[44px]">
      <CameraIcon />
      <p className="font-['BIZ_UDPGothic:Bold',sans-serif] leading-[1.25] not-italic relative shrink-0 text-[#5a6b8b] text-[12px] text-center tracking-[0.48px]">レシート</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-[20px] relative w-full">
          <Frame18 />
          <p className="font-['BIZ_UDPGothic:Bold',sans-serif] leading-[1.25] not-italic relative shrink-0 text-[#0a0604] text-[24px] text-center tracking-[0.96px]">入力</p>
          <Frame17 />
        </div>
      </div>
    </div>
...
function UnitTextM1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="unit_text_M">
      <p className="font-['Noto_Sans:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.5] opacity-0 relative shrink-0 text-[#a2a3a4] text-[16px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        ここにテキストが入ります
      </p>
    </div>
  );
    ...
    <div className="h-0 relative shrink-0 w-full">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 390 1">
          <g id="Frame 26087523">
            <line id="Line 162" stroke="var(--stroke-0, #D8D8D8)" x1="16" x2="374" y1="0.5" y2="0.5" />
          </g>
        </svg>
      </div>
    </div>
...
function CloseRoundedIcon1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="CloseRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="CloseRoundedIcon">
          <mask height="24" id="mask0_2_23361" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_2_23361)">
            <path d={svgPaths.p14d01a00} fill="var(--fill-0, #5A6B8B)" />
          </g>
        </g>
      </svg>
    </div>
...
function ChevronDownRoundedIcon1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ChevronDownRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ChevronDownRoundedIcon">
...
function LogbookDisplayEdit() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col items-center left-1/2 pb-[40px] rounded-tl-[24px] rounded-tr-[24px] top-[33px] w-[390px]" data-name="logbook_display_edit">
      <Frame27 />
      <Frame33 />
    </div>
  );
