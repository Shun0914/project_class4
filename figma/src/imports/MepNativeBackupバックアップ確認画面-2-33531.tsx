import svgPaths from "./svg-165rtyicb0";
...
function Frame31() {
  return (
    <div className="bg-[rgba(255,255,255,0.8)] content-stretch flex flex-col gap-[8px] items-start overflow-clip p-[12px] relative rounded-[8px] shrink-0 w-[358px]">
      <Title />
      <GraphArea />
      <Frame38 />
    </div>
