import svgPaths from "./svg-u3nccw5wpm";
...
function Loading() {
  return (
    <div className="absolute left-0 size-[24px] top-0" data-name="Loading">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Loading">
          <mask height="24" id="mask0_2_27336" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_2_27336)">
            <path d={svgPaths.p10167a80} fill="var(--fill-0, white)" id="progress_activity" />
          </g>
        </g>
      </svg>
    </div>
...
function ButtonMasterSp5() {
  return (
    <div className="bg-[#a6a5a4] h-[48px] relative rounded-[999px] shrink-0 w-full" data-name="Button_Master_SP">
      <div className="flex flex-row items-center size-full">
