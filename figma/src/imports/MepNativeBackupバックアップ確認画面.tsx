import svgPaths from "./svg-phu49jyac3";
...
function Frame20() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0">
      <p className="[text-decoration-skip-ink:none] decoration-solid font-['Noto_Sans:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#5a6b8b] text-[12px] underline" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        もっとみる
      </p>
      <InlineLeft3 />
    </div>
