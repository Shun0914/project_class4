import svgPaths from "./svg-5jr57dmaw1";
  ...
  return (
    <div className="absolute left-0 size-[32px] top-px" data-name="HomeIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_1_1336)" id="HomeIcon">
          ...
          <g mask="url(#mask0_1_1336)">
            <path d={svgPaths.p2c2ce00} fill="url(#paint0_linear_1_1336)" id="Vector" />
          </g>
        </g>
        <defs>
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="AddRoundedIcon">
          ...
          <g mask="url(#mask0_1_1324)">
            <path d={svgPaths.p363b8400} fill="url(#paint0_linear_1_1324)" id="Vector" />
          </g>
        </g>
        <defs>
...
function CameraIcon() {
  return (
    <div className="absolute left-0 size-[24px] top-0" data-name="CameraIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="CameraIcon">
          <mask height="24" id="mask0_1_1316" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_1_1316)">
            <path d={svgPaths.p1b346380} fill="url(#paint0_linear_1_1316)" id="photo_camera" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1316" x1="2.7507" x2="18.9653" y1="3.12807" y2="23.4156">
            <stop stopColor="#F68C44" />
            <stop offset="0.331731" stopColor="#FD9650" />
            <stop offset="1" stopColor="#EB6B15" />
          </linearGradient>
...
function DashboardIcon() {
  return (
    <div className="absolute left-0 size-[24px] top-0" data-name="DashboardIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_1_1371)" id="DashboardIcon">
          <path d={svgPaths.p37ed9900} fill="url(#paint0_linear_1_1371)" id="Vector" />
        </g>
        <defs>
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="CurrencyYenIcon">
          ...
          <g mask="url(#mask0_1_1361)">
            <path d={svgPaths.p33f46540} fill="url(#paint0_linear_1_1361)" id="currency_yen" />
          </g>
        </g>
        <defs>
  ...
  return (
    <div className="bg-[#f7f6f5] relative rounded-[16px] shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start px-[20px] relative w-full">
        <div className="flex flex-col font-['Noto_Sans_JP:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a0604] text-[16px] w-full">
