import svgPaths from "./svg-6luu9rfr4h";
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <p className="col-1 font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] ml-0 mt-0 not-italic relative row-1 text-[#2a3449] text-[16px]">ニックネーム</p>
    </div>
  );
}
...
function InputTextFieldM() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Input(TextField)_M">
      <Frame />
    </div>
  );
}
...
function InputUinitM() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[326px]" data-name="input_uinit-M">
      <UnitTextLabelM />
      <InputTextFieldM />
    </div>
  );
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <p className="col-1 font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] ml-0 mt-0 not-italic relative row-1 text-[#2a3449] text-[16px]">1週間レポート</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <p className="col-1 font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] ml-0 mt-0 not-italic relative row-1 text-[#2a3449] text-[16px]">分析設定</p>
    </div>
  );
}
...
function UnitTextLabelM2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 w-[326px]" data-name="unit_TextLabel_M">
      <Group2 />
    </div>
  );
}
...
function LoginScreen() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-end relative shrink-0 w-full" data-name="LoginScreen">
      <Frame3 />
      <Frame4 />
      <Frame5 />
      <Button4 />
