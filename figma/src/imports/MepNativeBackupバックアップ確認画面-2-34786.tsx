import svgPaths from "./svg-w4u1l5g6a2";
      ...
      <div className="absolute inset-[-9.09%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 130 130">
          <g id="Group 26086853">
            ...
            <path d={svgPaths.p2d1d22c0} id="Ellipse 169" stroke="var(--stroke-0, #FA4848)" strokeWidth="10" />
          </g>
        </svg>
      </div>
    </div>
...
export default function MepNativeBackup() {
  return (
    <div className="relative size-full" data-name="MEP-Native-backup. バックアップ確認画面" style={{ backgroundImage: "linear-gradient(139.791deg, rgb(255, 253, 242) 0%, rgb(255, 252, 239) 45.29%, rgb(255, 242, 234) 100%)" }}>
      <Frame21 />
      <ScrollWrapper />
      <Frame36 />
      <Frame1 />
