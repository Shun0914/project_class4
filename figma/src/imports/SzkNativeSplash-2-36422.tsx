import svgPaths from "./svg-8etxcn554b";
...
function SnackbarV() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f2fffe] bottom-[64px] left-[calc(50%+0.5px)] rounded-[6px] w-[343px]" data-name="Snackbar_v2">
