import svgPaths from "./svg-wxtqfr4va6";
...
function DateDefault() {
  return (
    <div className="content-stretch flex items-center justify-between relative rounded-[12px] shrink-0 w-[358px]" data-name="date/Default">
      <ChevronButton />
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[22px]">2025年10月</p>
      <ChevronButton1 />
    </div>
  );
}
...
function Title() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[8px] relative shrink-0 w-full" data-name="title">
      ...
      <p className="flex-[1_0_0] font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#2a3449] text-[16px] whitespace-pre-wrap">2025年10月予算</p>
      ...
      <div className="absolute inset-[-9.09%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 130 130">
          <g id="Group 26086853">
            ...
            <path d={svgPaths.pea9800} id="Ellipse 174" stroke="var(--stroke-0, #ED0101)" strokeWidth="10" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center leading-[0] not-italic relative shrink-0 text-[#ed0101] whitespace-nowrap">
...
function PieChartArea() {
  return (
    <div className="content-stretch flex flex-col gap-[6.94px] items-center justify-center p-[6px] relative shrink-0" data-name="pieChartArea">
      <div className="flex flex-col font-['Noto_Sans_JP:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ed0101] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[1.5]">予算オーバー</p>
      </div>
      <Frame33 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-[1_0_0] font-['Noto_Sans_JP:Bold',sans-serif] gap-[4px] items-center justify-end leading-[1.25] min-h-px min-w-px relative text-right">
      <p className="relative shrink-0 text-[20px]">14,000</p>
      <p className="relative shrink-0 text-[16px]">円</p>
    </div>
  );
}
    ...
    <div className="bg-[#f7f6f5] relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[8px] py-[16px] relative w-full">
          <div className="flex flex-col font-['Noto_Sans_JP:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#5a6b8b] text-[16px] text-center text-ellipsis w-full">
  ...
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="DashboardIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_28673)" id="DashboardIcon">
          <path d={svgPaths.p1aa6baf0} fill="var(--fill-0, white)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2_28673">
...
function Frame31() {
  return (
    <div className="bg-[rgba(255,255,255,0.8)] content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[8px] shrink-0 w-[358px]">
      <Title />
      <GraphArea />
      <Frame38 />
      <ButtonMasterSp />
...
function Frame40() {
  return (
    <div className="content-stretch flex items-end relative shrink-0 text-[#2a3449] text-center">
      <p className="relative shrink-0 text-[16px]">1,200</p>
...
function Frame5() {
  return (
    <div className="content-stretch flex font-['Noto_Sans_JP:Bold',sans-serif] gap-[4px] items-center leading-none not-italic relative shrink-0">
      <Frame40 />
      <p className="relative shrink-0 text-[#445371] text-[12px] text-right w-[37px] whitespace-pre-wrap">12.0%</p>
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="content-stretch flex items-end relative shrink-0 text-[#2a3449] text-center">
      <p className="relative shrink-0 text-[16px]">800</p>
      <p className="relative shrink-0 text-[12px]">円</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex font-['Noto_Sans_JP:Bold',sans-serif] gap-[4px] items-center leading-none not-italic relative shrink-0">
      <Frame41 />
      <p className="relative shrink-0 text-[#445371] text-[12px] text-right w-[37px] whitespace-pre-wrap">8.0%</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex font-['Noto_Sans_JP:Bold',sans-serif] gap-[4px] items-center leading-none not-italic relative shrink-0">
      <Frame42 />
      <p className="relative shrink-0 text-[#445371] text-[12px] text-right w-[37px] whitespace-pre-wrap">5.0%</p>
    </div>
  );
}
...
function Frame45() {
  return (
    <div className="content-stretch flex items-end relative shrink-0 text-[#2a3449] text-center">
      <p className="relative shrink-0 text-[16px]">10,500</p>
      <p className="relative shrink-0 text-[12px]">円</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex font-['Noto_Sans_JP:Bold',sans-serif] gap-[4px] items-center leading-none not-italic relative shrink-0">
      <Frame45 />
      <p className="relative shrink-0 text-[#445371] text-[12px] text-right">105.0%</p>
    </div>
  );
}
...
function LegendItem6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="legend_item">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#2a3449] text-[16px] w-[176px] whitespace-pre-wrap">10/27~11/02 のレポート</p>
    </div>
  );
}
...
function LegendItem7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="legend_item">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#2a3449] text-[16px]">11/03~11/09 のレポート</p>
    </div>
  );
}
...
function LegendItem8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="legend_item">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#2a3449] text-[16px]">11/10~11/16 のレポート</p>
    </div>
  );
}
...
function LegendItem9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="legend_item">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#2a3449] text-[16px]">11/17~11/23 のレポート</p>
    </div>
  );
}
...
function LegendItem10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="legend_item">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#2a3449] text-[16px]">11/24~11/30 のレポート</p>
    </div>
  );
}
...
export default function MepNativeBackup() {
  return (
    <div className="relative size-full" data-name="MEP-Native-backup. バックアップ確認画面" style={{ backgroundImage: "linear-gradient(152.421deg, rgb(255, 253, 242) 0%, rgb(255, 252, 239) 45.29%, rgb(255, 242, 234) 100%)" }}>
      <Frame30 />
      <ScrollWrapper />
      <Frame57 />
      <Frame1 />
