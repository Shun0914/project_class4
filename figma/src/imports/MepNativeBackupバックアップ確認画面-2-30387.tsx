import svgPaths from "./svg-pduqwafvlb";
...
function DateDefault() {
  return (
    <div className="content-stretch flex items-center justify-between relative rounded-[12px] shrink-0 w-[358px]" data-name="date/Default">
      <ChevronButton />
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[22px]">2025年011月</p>
      <ChevronButton1 />
    </div>
  );
}
...
function Title() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[8px] relative shrink-0 w-full" data-name="title">
      ...
      <p className="flex-[1_0_0] font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#2a3449] text-[16px] whitespace-pre-wrap">2025年11月予算</p>
    ...
    <div className="bg-[#f7f6f5] relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center not-italic px-[20px] relative w-full">
          ...
          <div className="flex flex-col font-['Noto_Sans_JP:Regular',sans-serif] justify-center leading-[0] min-w-full overflow-hidden relative shrink-0 text-[#5a6b8b] text-[16px] text-center text-ellipsis w-[min-content]">
            <p className="leading-[1.5] whitespace-pre-wrap">今月の分析結果はありません</p>
          </div>
        </div>
      </div>
...
function DashboardIcon1() {
  return (
    <div className="absolute left-0 size-[24px] top-0" data-name="DashboardIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_2_28662)" id="DashboardIcon">
          <path d={svgPaths.p37ed9900} fill="var(--fill-0, white)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2_28662">
...
function Title8() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="title">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[16px] text-white">分析する</p>
    </div>
  );
}
...
function ButtonMasterSp5() {
  return (
    <div className="h-[48px] relative rounded-[999px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.06)] shrink-0 w-full" data-name="Button_Master_SP" style={{ backgroundImage: "linear-gradient(173.762deg, rgb(255, 160, 76) 2.1423%, rgb(251, 180, 65) 34.595%, rgb(240, 110, 35) 99.971%)" }}>
      <div className="flex flex-row items-center size-full">
