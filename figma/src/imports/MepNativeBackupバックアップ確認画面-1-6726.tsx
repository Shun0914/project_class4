import svgPaths from "./svg-07u3m5pzue";
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[326px]" data-name="Container">
      <p className="font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.1504px]">レポート単位</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[23.988px] left-0 top-0 w-[73.395px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Noto_Sans_JP:Bold',sans-serif] leading-[24px] left-[37px] not-italic text-[#2a3449] text-[16px] text-center top-[-2.27px]">1週間単位</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute content-stretch flex h-[21.004px] items-start left-0 top-[23.99px] w-[167.893px]" data-name="Paragraph">
      <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#5a6b8b] text-[14px] text-center">毎週レポートを送信します</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="h-[44.992px] relative shrink-0 w-[167.893px]" data-name="Container">
...
function Button() {
  return (
    <div className="bg-[#fff8f3] h-[79.521px] relative rounded-[12px] shrink-0 w-[309.57px]" data-name="Button">
...
function Paragraph2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[73.395px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Noto_Sans_JP:Bold',sans-serif] leading-[24px] left-[37px] not-italic text-[#2a3449] text-[16px] text-center top-[-2.27px]">1ヶ月単位</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[21.004px] relative shrink-0 w-[167.893px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Noto_Sans_JP:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#5a6b8b] text-[14px] text-center">毎月レポートを送信します</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-white h-[79.521px] relative rounded-[12px] shrink-0 w-[309.57px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pl-[17.265px] pr-[124.413px] py-[1.273px] relative size-full">
        <Container7 />
      </div>
    </div>
  );
