import svgPaths from "./svg-a2fn98t407";
...
function ChevronRightRoundedIcon1() {
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="ChevronRightRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="ChevronRightRoundedIcon">
...
function Frame53() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[14px]">12/29~01/04 のレポート</p>
      <InlineLeft2 />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-col font-['Noto_Sans_JP:Regular',sans-serif] h-[71px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#6f6d6c] text-[16px] text-ellipsis w-full">
        <p className="leading-[1.5] whitespace-pre-wrap">ここに一週間前のレポートが表示されます。ここに一週間前のレポートが表示されます。ここに一週間前のレポートが表示されます。ここに一週間前のレポートが表示されます。ここに一週間前のレポートが表示されます。ここに一週間前のレポートが表示されます。</p>
      </div>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 326 1">
            <line id="Line 161" stroke="var(--stroke-0, #F3F3F3)" x2="326" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function ChevronRightRoundedIcon2() {
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="ChevronRightRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="ChevronRightRoundedIcon">
...
function Frame55() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[14px]">01/05~01/11 のレポート</p>
      <InlineLeft3 />
    </div>
  );
}
...
function ChevronRightRoundedIcon3() {
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="ChevronRightRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="ChevronRightRoundedIcon">
...
function Frame57() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[14px]">01/12~01/18 のレポート</p>
      <InlineLeft4 />
    </div>
  );
}
...
function ChevronRightRoundedIcon4() {
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="ChevronRightRoundedIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="ChevronRightRoundedIcon">
...
function Frame59() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
      <p className="font-['Noto_Sans_JP:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#2a3449] text-[14px]">01/19~01/25 のレポート</p>
      <InlineLeft5 />
    </div>
  );
}
