...
- App Service **tech0-gen-11-step3-2-py-51**（バックエンド）が存在すること
...
1. Azure Portal で **tech0-gen-11-step3-2-py-51** を開く
2. 左側メニューで **「設定」→「ID」** を選択
...
5. **「プリンシパルの選択」** で **tech0-gen-11-step3-2-py-51** のマネージド ID を検索して選択
6. **「追加」** → **「保存」** をクリック
...
1. **tech0-gen-11-step3-2-py-51** の **「設定」→「構成」→「アプリケーション設定」** を開く
